...
* [Stack Structure](structure/intro.md)
    * [General structure](structure/general.md)
    * [Python stack structure](structure/python.md)
* [Installation and deployment](install/intro.md)
